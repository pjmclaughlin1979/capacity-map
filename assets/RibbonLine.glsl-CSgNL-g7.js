...
return vec4(col, opacity);
  ...
  `)}function wt(t){const e=t.stipplePattern;return Pt(e)?e.length:e?pa(e)/e.pixelRatio:1}const ma=.4,Ct=64,va=Ct/2,ga=va/5,Sa=Ct/ga,pn=.25;function xa(t,e){const a=t.vertex,i=e.hasScreenSizePerspective;qe(a),a.uniforms.get("markerScale")==null&&a.constants.add("markerScale","float",1),a.constants.add("markerSizePerLineWidth","float",Sa).code.add(s`
