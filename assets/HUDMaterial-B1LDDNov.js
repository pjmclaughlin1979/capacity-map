...
return vec4(result, clipCoord.zw);
  ...
  `),e.varyings.add("vcolor","vec4"),e.varyings.add("vtc","vec2"),e.varyings.add("vsize","vec2");const w=r===10;x.uniforms.add(new ke("viewport",n=>n.camera.fullViewport),new oe("screenOffset",(n,I)=>he(X,2*n.screenOffset[0]*I.camera.pixelRatio,2*n.screenOffset[1]*I.camera.pixelRatio)),new oe("anchorPosition",n=>K(n)),new ae("materialColor",({color:n})=>n),new q("materialRotation",n=>n.rotation),new oe("materialSize",n=>n.size),new Z("tex",n=>n.texture)),He(x),s&&(x.uniforms.add(new ae("outlineColor",n=>n.outlineColor)),f.uniforms.add(new ae("outlineColor",n=>Ve(n)?n.outlineColor:Ot),new q("outlineSize",n=>Ve(n)?n.outlineSize:0))),i&&x.include(Aa),o&&(ga(x),Ne(x)),p&&e.varyings.add("debugBorderCoords","vec4"),e.attributes.add("uv0","vec2"),S&&e.attributes.add("uvi","vec4"),D&&e.attributes.add("color","vec4"),F&&e.attributes.add("size","vec2"),P&&e.attributes.add("rotation","float"),(d||v)&&e.attributes.add("featureAttribute","vec4"),x.main.add(l`
